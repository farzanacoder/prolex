  ...
  return (
    <section className='bg-white py-20'>
        <div className='container'>
            ...
            <Image src='/Watch3.png' alt='batery' className='ele_mover' data-aos="fade-down" width={1000} height={500}/>

            <div className='grid grid-cols-2 text-center gap-10'>
                <div className='col px-20'>
                    <h3 className='text-[22px] font-semibold flex justify-center text-primary  gap-2 items-center '>Up to <span className='text-[90px]'>10</span> days</h3>
                ...
                <div className='col px-20'>
                    <h3 className='text-[22px] font-semibold flex justify-center text-primary  gap-2 items-center '><span className='text-[90px] font-bold'>45</span> hours</h3>
