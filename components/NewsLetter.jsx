...
export default function NewsLetter() {
  ...
  return (
    <section className='bg-white py-20' data-aos="fade-up">
       ...
       <form action="" className='bg-gray-100 relative w-[550px] h-[65px] m-auto rounded-full overflow-hidden border border-[rgba(0,0,0,0.1)]'>
        <input type="text" className='w-full h-full bg-gray-100 outline-none px-4' placeholder='info@yourdomain.com'/>
        <Button className='!bg-primary !text-xl !font-semibold !capitalize !w-[165px] !h-full !text-white !px-5 !py-3 !absolute top-0 right-0 hover:!bg-secondary !rounded-r-full'>Subscribe</Button>
       </form>
        </div>
    </section>
  )
